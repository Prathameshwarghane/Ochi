    ...
    <div className="eyes w-full h-screen overflow-hidden ">
      ...
      >
        <div className="absolute flex gap-9 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] ">
          <div className=" h-[13vw] w-[13vw] flex items-center justify-center bg-[#F4F4F4] rounded-full">
            <div className="relative w-2/3 h-2/3 rounded-full bg-zinc-900">
              <div
                style={{
                  transform: `translate(-50%,-50%) rotate(${rotate}deg)`,
                }}
                className="line absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] m-[2px] w-full h-10 p-[3px]"
              >
