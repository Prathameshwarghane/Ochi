...
const Ready = () => {
  return (
    <div className="w-full h-screen pt-[10vh] pl-[3.6vw] bg-[#F1F1F1] flex">
      <div className=" w-1/2 h-full flex flex-col justify-between tracking-tight ">
        <div className="heading">
          <h1 className="font-['Founders_Grotesk_X'] text-[18vh] -mb-[14vh] font-medium text-[#212121]">
            EYE-
          </h1>
          <h1 className="font-['Founders_Grotesk_X'] text-[18vh] -mb-[14vh] font-medium text-[#212121]">
            OPENING
      ...
      <div>
        <h1 className="uppercase font-['Founders_Grotesk_X'] text-[18vh] -mb-[14vh] font-medium pr-[4.5vw] text-[#212121]">
          presentations
        </h1>
        <div>
          <div className="container mt-[9.5vh] font-['Neue_Montreal'] ">
            ...
            <div className="container flex justify-between ">
              <div className="capitalize flex flex-col ">
                ...
                {["Instagram", "Behance", "Facebook", "Linkedin"].map(
                  (item, index) => (
                    <a
                      className="font-['Neue_Montreal'] underline underline-offset-4"
                      href="#"
                    >
                      {item}
                    </a>
              ...
              <div className="capitalize flex flex-col pr-[6vw] ">
                <div>M:</div>
                <br />
                {[
                  "Home",
